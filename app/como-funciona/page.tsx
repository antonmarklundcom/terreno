  ...
  return (
    <div className="container-page max-w-prose py-8 sm:py-12">
      ...
      <p className="mt-3 text-[15.5px] leading-relaxed text-ink-prose">
        ...
        campos, quintas y loteamientos con información clara, y acompañamos
        tanto a quien compra como a quien vende.
      </p>
      ...
      <div className="mt-8 flex flex-col gap-4">
        {PILARES.map(({ icon: Icon, titulo, texto }) => (
          <div
            key={titulo}
            className="flex items-start gap-3.5 rounded-card border border-line bg-surface p-5"
          >
