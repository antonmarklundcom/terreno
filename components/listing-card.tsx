    ...
    >
      ...
      <div className="p-3.5">
        <div className="flex items-baseline justify-between gap-2">
          <div className="tnum text-[19px] font-bold tracking-tight2">
            {price}
          </div>
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1 p-4">
        <div className="flex items-baseline justify-between gap-2">
          <div className="tnum text-[18px] font-bold tracking-tight2">
            {price}
          </div>
          <div className="tnum text-[12.5px] font-semibold text-brand">
            {per}
          </div>
        </div>
